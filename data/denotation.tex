...
\begin{denotation}[3cm]
  ...
  \item[REST] 表述性状态转移（Representational State Transfer）
  \item[OpenAPI] 开放API规范（OpenAPI Specification）
  \item[Jest] JavaScript测试框架
  \item[IoTDB] 物联网数据库（Internet of Things Database）
\end{denotation}
